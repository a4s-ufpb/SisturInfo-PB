package com.example.sisturinfo_pb.Adapter;
...
public class AtrativosAdapter extends BaseAdapter implements BaseSliderView.OnSliderClickListener,BaseSliderView.ImageLoadListener{
    ...
    private static ArrayList<AtrativoTuristico> list;
    private Context ctx;


    public AtrativosAdapter(Context c , ArrayList<AtrativoTuristico> at ){
        this.ctx=c;
        this.list=at;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AtrativoTuristico at = list.get(position);
